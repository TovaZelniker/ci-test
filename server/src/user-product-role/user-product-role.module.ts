...
@Module({
  imports: [DbValidationModule, MongooseModule.forFeature([{ name: Product.name, schema: ProductSchema }, { name: Role.name, schema: RoleSchema }, { name: User.name, schema: UserSchema }, { name: UserProductRole.name, schema: UserProductRoleSchema }, { name: Workflow.name, schema: WorkflowSchema }])],
